...
ssh $SSH_OPTIONS $SSH_REMOTE_USER@$SSH_REMOTE_HOST "cd $REMOTE_WORKING_PATH; killall $REMOTE_ARM_BIN"

echo -ne "\nLaunch program on ARM... \e[92m \n"
ssh $SSH_OPTIONS $SSH_REMOTE_USER@$SSH_REMOTE_HOST "cd $REMOTE_WORKING_PATH; ./$REMOTE_ARM_BIN"
