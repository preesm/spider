...
class CSDAGVertex {
	...
	private :
		...
		*/
		int paramValues[MAX_CSDAG_VERTEX_REPETITION][MAX_PARAM];
...
int CSDAGVertex::getParamValue(int srDagRepetitionIndex, int paramIndex){
	return paramValues[srDagRepetitionIndex][paramIndex];
}
...
void CSDAGVertex::setParamValue(int srDagRepetitionIndex, int paramIndex, int value){
	paramValues[srDagRepetitionIndex][paramIndex] = value;
}
