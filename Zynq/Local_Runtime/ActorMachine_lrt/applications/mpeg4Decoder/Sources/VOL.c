...
int VideoObjectLayer ( const int pos_i, int length, const unsigned char *RESTRICT data, // inputs
		struct_VOLsimple *RESTRICT VOLsimple, unsigned char *RESTRICT vop_complexity, int *RESTRICT pos_o, int *xsize, int *ysize )// outputs
{
    int             position = pos_i ;
